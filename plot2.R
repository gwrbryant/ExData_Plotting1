# This code is used to produce a time series plot of data in the 
...
# Calculate the date and time (DAT) for the x-axis

    DAT<-strptime(paste(power$Date," ",power$Time), "%d/%m/%Y %H:%M:%S")

# Open the PNG graphic device

    png("plot2.png", bg="transparent", res=96, pointsize=9)
...
# Plot the time series
    ...
    plot(DAT, power$Global_active_power, 
